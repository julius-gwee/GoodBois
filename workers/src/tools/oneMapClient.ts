// workers/src/tools/oneMapClient.ts
//
// OneMap routing API client: token auth, route fetch per mode/source, and the
// polyline / geometry / distance helpers used to shape a OneMap response into
// a RouteOption. The kiosk origin and demo fallback live elsewhere — this
// module only talks to OneMap. See ./oneMapRouting for the findRoutes entry.
...
export async function resolveOneMapRoute(
